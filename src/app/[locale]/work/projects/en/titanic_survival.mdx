...
# Load the data
train_df = pd.read_csv(r"C:\Users\ibrah\OneDrive\Desktop\Coding\train_data.csv")
...
![Age Distribution](./public/images/age_distribution.png "Age Distribution")
...
y_true = train_df['Survived']  # Replace with test_df for actual testing
y_pred = train_df['Survived']  # Simulated predictions
